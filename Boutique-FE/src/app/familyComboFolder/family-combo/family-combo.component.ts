...
@Component({
  selector: 'app-family-combo',
  imports: [CommonModule, FormsModule],
  standalone:true,
  templateUrl: './family-combo.component.html',
  styleUrl: './family-combo.component.css'
})
export class FamilyComboComponent {
    ...
    getSareeItems(): void {
      this.httpService.get(`${this.url}/api/items/getItem?category=familycombo&isCustomizable=true`).subscribe((data: any) => {
        this.items = data;
    ...
    selectCard(index: number): void {
      ...
      this.router.navigate([`/familycombo/${selectedProduct.id}`]);
    }
  }
