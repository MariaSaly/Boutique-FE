...
@Component({
  ...
  styleUrl: './mens-wear.component.css'
})
export class MensWearComponent {
    ...
    getSareeItems(): void {
      this.httpService.get(`${this.url}/api/items/getItem?category=menswear`).subscribe((data: any) => {
        this.items = data;
    ...
    selectCard(index: number): void {
      ...
      this.router.navigate([`/menswear/${selectedProduct.id}`]);
    }
  }
