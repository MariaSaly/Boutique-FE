...
@Component({
  selector: 'app-bridesquad',
  imports: [CommonModule],
  standalone:true,
  templateUrl: './bridesquad.component.html',
  styleUrl: './bridesquad.component.css'
})
export class BridesquadComponent {
    ...
    getSareeItems(): void {
      this.httpService.get(`${this.url}/api/items/getItem?category=bridalsquade`).subscribe((data: any) => {
        this.items = data;
