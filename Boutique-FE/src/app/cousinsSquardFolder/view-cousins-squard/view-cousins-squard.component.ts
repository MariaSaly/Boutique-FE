...
@Component({
  selector: 'app-view-cousins-squard',
  imports: [CommonModule , FormsModule],
  standalone:true,
  templateUrl: './view-cousins-squard.component.html',
  styleUrl: './view-cousins-squard.component.css'
})
export class ViewCousinsSquardComponent {
