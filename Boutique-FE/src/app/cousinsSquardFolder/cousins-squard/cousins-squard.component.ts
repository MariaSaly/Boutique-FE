...
@Component({
  selector: 'app-cousins-squard',
  imports: [FormsModule,CommonModule],
  standalone:true,
  templateUrl: './cousins-squard.component.html',
  styleUrl: './cousins-squard.component.css'
})
export class CousinsSquardComponent {
    ...
    getSareeItems(): void {
      this.httpService.get(`${this.url}/api/items/getItem?category=cousinsquade`).subscribe((data: any) => {
        this.items = data;
    ...
    selectCard(index: number): void {
      ...
      this.router.navigate([`/cousinsquade/${selectedProduct.id}`]);
    }
  }
